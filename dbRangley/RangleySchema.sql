...
DROP TABLE IF exists rangley.tb_friend_groups 
DROP TABLE IF exists rangley.tb_friend_groups_members 
...
CREATE TABLE rangley.tb_friend_groups
(
     friend_group_id    INT8        GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY
    ,created_by_user_id INT8        NOT NULL
    ,name               VARCHAR(50) NOT NULL
    ,dttm_created_utc   TIMESTAMPTZ NOT NULL DEFAULT now()
    ,dttm_modified_utc  TIMESTAMPTZ NULL
...
CREATE TABLE rangley.tb_friend_group_members
(
...
CREATE INDEX idx_friend_group_members_user 
    ON rangley.tb_friend_group_members (user_id);
